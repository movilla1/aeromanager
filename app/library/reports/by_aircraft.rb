  ...
  class ByAircraft
    ...
    def execute
      ...
      if last_maintenance.present?
        remaining_hours = last_maintenance&.hours_extended.to_f # rubocop:disable Lint/NumberConversion
      ...
      { result: result, last_maintenance: last_maintenance&.hours_extended.to_f } # rubocop:disable Lint/NumberConversion
    end
  end
end
